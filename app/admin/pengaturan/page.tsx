  ...
  <div className="mb-5">
    ...
    <div className="relative group">
      ...
      <input
        ...
        disabled={disabled}
        className={`w-full bg-gray-50 border border-gray-200 rounded-xl py-3 pl-12 ${
          RightIcon ? "pr-12" : "pr-4"
        } text-sm font-medium text-[#1B1B1B] focus:ring-2 focus:ring-[#233982]/20 focus:border-[#233982] outline-none transition-all ${
